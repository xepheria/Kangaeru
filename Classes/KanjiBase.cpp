...
Menu *KanjiBase::createKBMenu(){
   ...
   auto back_menu = MenuItemLabel::create(Label::create("Back", "Arial", 48), this, menu_selector(KanjiBase::backToMainScene));
   auto N5_dictionary = MenuItemLabel::create(Label::create("N5 Dictionary", "Arial", 48), this, menu_selector(KanjiBase::N5Callback));
...
void KanjiBase::addToExistingListCallback(cocos2d::Ref *pSender){
   ...
   //add new term
   kanjiDict[(kanjiEntry.at("Kanji").asString())] = kanjiEntry;
   //save new dictionary
...
void KanjiBase::createNewListCallback(cocos2d::Ref *pSender){
   ...
   if(_createNewListScreenUp == false){
      ...
      createNewList = LayerColor::create(Color4B(0, 0, 0, 80), winSize.width, winSize.height);
...
//      this->addChild(enterListName, 14);
      ...
      auto backFromNewList = MenuItemLabel::create(Label::create("Back", "fonts/falcon.ttf", 40), this, menu_selector(KanjiBase::returnToAddToListCallback));
      auto confirmNewList = MenuItemLabel::create(Label::create("Confirm new \nlist", "fonts/falcon.ttf", 40), this, menu_selector(KanjiBase::confirmNewListCallback));
...
void KanjiBase::addToListCallback(cocos2d::Ref *pSender){
   if(_addToListScreenUp == false){
      ...
      //auto *addToListItem = MenuItemImage::create("addToListMenuButton.png", "addToListMenuButtonselected.png", this, menu_selector(KanjiBase::addToExistingListCallback));
      auto *makeNewListItem = MenuItemImage::create("makeNewListButton.png", "makeNewListButtonselected.png", this, menu_selector(KanjiBase::createNewListCallback));
      makeNewListItem->setTag(ref->getTag());
      auto *backLabel = MenuItemLabel::create(Label::create("Back", "fonts/falcon.ttf", 48), this, menu_selector(KanjiBase::backAddToListCallback));
      
      _addToListMenu = Menu::create(makeNewListItem, backLabel, nullptr);
      _addToListMenu->setPosition(winSize.width*.3, winSize.height/2);
      ...
      for(int i = 0; i < UserDefault::getInstance()->getIntegerForKey("numOfLists"); i++){
         auto addToDaMenu = MenuItemLabel::create(Label::create(userLists[i].c_str(), "fonts/falcon.ttf", 28), this, menu_selector(KanjiBase::addToExistingListCallback));
         addToDaMenu->setTag(ref->getTag());
         _existingListsMenu->addChild(addToDaMenu);
      }
      _existingListsMenu->setPosition(winSize.width*.7, winSize.height/2);
      _existingListsMenu->alignItemsVerticallyWithPadding(5);
...
void KanjiBase::N5Callback(cocos2d::Ref *pSender){
   ...
   //create back button
   N5back_menu = MenuItemLabel::create(Label::create("Back", "Arial", 48), this, menu_selector(KanjiBase::backToMainMenu));
   ...
   //init kanjiInfoMenu
   kanjiLabel = Label::create("some info about the kanji", "fonts/falcon.ttf", 28);
   ...
   kanjiAddToListButton = MenuItemImage::create("addToListButton.png", "addToListButtonselected.png", this, menu_selector(KanjiBase::addToListCallback));
...
void KanjiBase::saveData(){
   ...
   for(int i = 0; i < 10; i++){
      ...
      if(i < userLists.size()){
         ...
         cout << listName << ": " << UserDefault::getInstance()->getStringForKey(listName.c_str()) << endl;
      }
      else{
         cout << "default string val: " << UserDefault::getInstance()->getStringForKey("asdfasdf") << endl;
