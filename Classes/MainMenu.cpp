...
bool MainMenu::init()
{
    ...
    //game 1
    auto *pGame1Item = MenuItemLabel::create(Label::create("Kanji Lists", "fonts/falcon.ttf", 72), this, menu_selector(MainMenu::menuGame1Callback));
   dynamic_cast<Label*>(pGame1Item->getLabel())->enableOutline(Color4B::BLACK, 1);
    pMenuItems.pushBack(pGame1Item); //add to list
    
    //game 2
    auto *pGame2Item = MenuItemLabel::create(Label::create("Game Demo", "fonts/falcon.ttf", 72), this, menu_selector(MainMenu::menuGame2Callback));
    dynamic_cast<Label*>(pGame2Item->getLabel())->enableOutline(Color4B::BLACK, 1);
    pMenuItems.pushBack(pGame2Item);
    
    //close menu
    auto *pCloseItem = MenuItemLabel::create(Label::create("Quit", "fonts/falcon.ttf", 72), this, menu_selector(MainMenu::menuCloseCallback));
