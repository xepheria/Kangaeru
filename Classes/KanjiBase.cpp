...
Menu *KanjiBase::createKBMenu(){
   ...
   auto back_menu = MenuItemLabel::create(Label::create("Back", "fonts/falcon.ttf", 60), this, menu_selector(KanjiBase::backToMainScene));
   auto N5_dictionary = MenuItemLabel::create(Label::create("N5 Dictionary", "fonts/falcon.ttf", 60), this, menu_selector(KanjiBase::N5Callback));
...
void KanjiBase::addToListCallback(cocos2d::Ref *pSender){
   if(_addToListScreenUp == false){
      ...
      auto *makeNewListItem = MenuItemLabel::create(Label::create("Make New List", "fonts/falcon.ttf", 48), this, menu_selector(KanjiBase::createNewListCallback));
      ...
      for(int i = 0; i < UserDefault::getInstance()->getIntegerForKey("numOfLists"); i++){
         auto addToDaMenu = MenuItemLabel::create(Label::create(userLists[i].c_str(), "fonts/falcon.ttf", 40), this, menu_selector(KanjiBase::addToExistingListCallback));
         addToDaMenu->setTag(ref->getTag());
         _existingListsMenu->addChild(addToDaMenu);
      }
...
void KanjiBase::N5Callback(cocos2d::Ref *pSender){
   ...
   //create back button
   N5back_menu = MenuItemLabel::create(Label::create("Back", "fonts/falcon.ttf", 60), this, menu_selector(KanjiBase::backToMainMenu));
   ...
   //init kanjiInfoMenu
   kanjiLabel = Label::create("some info about the kanji", "fonts/falcon.ttf", 36);
